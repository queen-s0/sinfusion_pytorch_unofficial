...
class ConvNextBlock(nn.Module):
    ...
    """
    def __init__(self, in_dim, out_dim, hid_dim, drop_path=0., layer_scale_init_value=1e-6):
        super().__init__()
        ...
        self.pwconv1 = nn.Linear(in_dim, hid_dim) # pointwise/1x1 convs, implemented with linear layers
        self.act = nn.GELU()
