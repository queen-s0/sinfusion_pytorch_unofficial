...
class Trainer(object):
    def __init__(
        ...
        **kwargs
        ...
        self.ds = ds
        dl = DataLoader(self.ds, batch_size = train_batch_size, pin_memory = True, num_workers=2, prefetch_factor = 32, persistent_workers=True)
        ...
        self.sched = MultiStepLR(self.opt, [50000, 100000])
    ...
    def load(self, milestone):
        ...
        data = torch.load(str(self.results_folder / f'model-{milestone:03d}.pt'), map_location=device)
