...
def main(args):
    ...
    diffusion = GaussianDiffusion(
        ...
        sampling_timesteps=args.samling_timesteps, # = 250,   # number of sampling timesteps (using ddim for faster inference [see citation for ddim paper])
...
if __name__ == '__main__':
    ...
    parser.add_argument('--sampling_T', default=50)
    parser.add_argument('-l', '--loss', default='l2')
    parser.add_argument('-T', '--timesteps', default=50)
